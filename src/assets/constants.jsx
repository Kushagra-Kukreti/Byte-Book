export const ByteBookLogo = () => (
 <img src="./logo.png" style={{width:"60%",objectFit:"cover"}} alt="" />
);

export const ByteBookMobileLogo = () => (
	<img src="mobileLogo.png" style={{width:"100%",objectFit:"cover"}} alt="" />
);
